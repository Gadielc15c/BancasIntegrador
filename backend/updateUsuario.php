...
<body>
    ...
    <div class="container mt-5">
        <form action="update.php" method="POST">
            <input type="hidden" class="form-control mb-3" name="CodigoArchivo" placeholder="CodigoArchivo "
                value="<?php echo $row['idterceros']  ?>">
            <input type="text" class="form-control mb-3" name="CodDepto" placeholder="Codigo de departamento"
                value="<?php echo $row['nomusuario']  ?>">
            <input type="text" class="form-control mb-3" name="AreaReferencia" placeholder="Area de Referencia"
                value="<?php echo $row['claveusuario']  ?>">
